local UI = CreateFrame('Frame', 'KeystoneCompanion', UIParent, 'BaseBasicFrameTemplate');
...
UI.Bg:SetSize(600, 400);
UI.Bg:SetDrawLayer('BACKGROUND', 0)
UI.Bg:SetAllPoints(UI);
UI.Bg:SetColorTexture(0.11, 0.14, 0.18, 0.7)
UI.Bg:Show();
